...
gboolean  __bt_is_matching_addressbook(const char *addressbook_name, int addressbook)
{
	gboolean is_sim_addressbook = _bt_is_sim_addressbook(addressbook_name);
...
static contacts_query_h __bluetooth_pb_query_person(int addressbook)
{
	...
	unsigned int i = 0;
	gint status;
	gboolean is_first_condition = true;
